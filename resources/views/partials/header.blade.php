<div class="px-4 py-4 flex flex-wrap justify-between items-center shadow-xl text-slate-200 bg-transparent">
    ...
    <div id="navbar" class="hidden absolute z-50 top-16 sm:top-20 bottom-0 left-0 w-full h-44 p-4 glassNav md:bg-transparent md:relative md:top-0 md:block md:w-auto md:h-auto shadow-xl transition-all duration-300">
      <ul class="flex flex-col font-medium md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-transparent">
          <li>
              <a href="{{ route('index') }}" class="block py-2 px-3 mt-2 sm:mt-0 md:p-0 text-gray-900 rounded-sm md:hover:bg-transparent md:border-0 md:hover:text-blue-400 dark:text-white hover:text-blue-500 md:dark:hover:bg-transparent">Products</a>
          </li>
          <li>
              <a href="#" class="block py-2 px-3 md:p-0 text-gray-900 rounded-sm md:hover:bg-transparent md:border-0 md:hover:text-blue-400 dark:text-white hover:text-blue-500 md:dark:hover:bg-transparent">Testimony</a>
          </li>
          <li>
              <a href="mailto:michellenathaniawinata@gmail.com" class="block py-2 px-3 md:p-0 text-gray-900 rounded-sm md:hover:bg-transparent md:border-0 md:hover:text-blue-400 dark:text-white hover:text-blue-500 md:dark:hover:bg-transparent">Contact</a>
          </li>
      </ul>
  </div>
